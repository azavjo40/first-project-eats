...
try{
const res = await fetch('https://azam-app-tj-js.pl/api/order',requestOptions )
...
try{
const res = await fetch(`https://azam-app-tj-js.pl/api/order/${contac._id}`,requestOptions )
const date = await res.json()
