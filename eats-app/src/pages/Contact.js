  ...
  <Container fluid="md" style={{marginTop: "3rem"}}>
    <Form>
      <Form.Group controlId="formBasicEmail">
        ...
        <Form.Control type="name" placeholder="Name" onChange={changehandler } name="name" value={form.name} />
      </Form.Group>
      <Form.Group controlId="formBasicPassword">
        <Form.Label>Phone</Form.Label>
        <Form.Control type="phone" placeholder="Phone" onChange={changehandler } name="phone" value={form.phone} />
      </Form.Group>
