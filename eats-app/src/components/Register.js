  ...
  <Container fluid="md" style={{marginTop: "3rem"}}>
    ...
    <Form>
      ...
      <Row>
        ...
        <Col>
        <Form.Control placeholder="Last name" name="surname" value={form.surname} onChange={changehandler} />
        </Col>
      </Row>
      ...
      <Form.Group>
        ...
        <Form.Control placeholder="Password" name="password" value={form.password} onChange={changehandler} />
      </Form.Group>

      <Form.Group controlId="formBasicPhone">
        <Form.Label>Phone</Form.Label>
        <Form.Control type="phone" placeholder="Phone" name="phone" value={form.phone} onChange={changehandler} />
      </Form.Group>
